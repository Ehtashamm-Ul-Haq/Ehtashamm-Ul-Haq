...
### Senior Software Engineer | Full-Stack & Agentic AI Systems

📍 Pakistan &nbsp;|&nbsp; 🎓 BS (Computer Science) — COMSATS University Islamabad, 2015–2019
...
I'm a **Full-Stack Software Engineer** with **6+ years of experience** designing, building, and scaling production-grade web applications and, more recently, **AI-driven automation and agentic systems**. I specialize in translating complex business requirements into robust, maintainable, and high-performance software — from API architecture to intuitive front-end experiences.

I've contributed to products used by real users across multiple startups, and I bring a pragmatic, ownership-driven approach to every project I work on.

> *"I build software that solves real problems — not just code that runs."*
...
- Leading full-stack development across multiple SaaS products, from architecture design to deployment
- Building AI automation pipelines and agentic workflows for client and internal products
- Mentoring engineers and driving code quality through structured reviews

**Software Engineer** — The Help Desk &nbsp;·&nbsp; *Jan 2020 – Jan 2021*
- Delivered features across the full stack for client-facing web applications
- Collaborated in agile teams to ship reliable, well-tested software on schedule

<br/>

## 🚀 What I'm Focused On

- Building scalable systems with the **MERN / MEAN** stack
- Designing and deploying **AI automations** and **agentic AI workflows**
- Architecting clean, high-performance **REST & GraphQL APIs**
- Exploring **LangChain** and **LangGraph** for intelligent, multi-step agent orchestration
- Open to collaborating on impactful, technically challenging projects

<br/>

## 🏆 Highlights

- 🥇 Built and shipped multiple production-grade SaaS applications, including work on **leagues.gg**, **Steppi**, **Mapstar**, and other startups
- ⚡ Designed high-performance REST & GraphQL APIs with caching and rate-limiting strategies
- 🧠 Mentored junior engineers and led code review processes for enterprise teams
- 🤖 Integrated AI-driven automation and intelligent agent systems into production workflows
...
*Open to collaboration on projects involving full-stack engineering, AI automation, and agentic systems.*
